...
@section('admincontent')
    ...
    <section class="content">
        <div class="container-fluid">
          <form method="POST" id="bookSubmitForm" action="{{ route('books.update', $book->id) }}"enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-7">
                               ...
                               <div id="general" class="tab-pane fade show active"> 
                                        ...
                                        <select id="author_id" name="author_id" title="Choose..." data-live-search="true"
                                            ...
                                            @foreach ($authors as $author)
                                                <option value="{{ $author->id }}"
                                                    {{ (old('author_id') == $author->id || (isset($book) && $book->author_id == $author->id))   ? 'selected' : '' }}>{{ $author->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('author_id')
                                        ...
                                        <select id="publisher_id" name="publisher_id"
                                            ...
                                            @foreach ($publishers as $publisher)
                                                <option value="{{ $publisher->id }}"
                                                    {{ (old('publisher_id') == $publisher->id || (isset($book)&& $book->publisher_id == $publisher->id)) ? 'selected' : '' }}>
                                    ...
                                    <div class="form-row mb-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" value="{{ old('publishing_date') ? old('publishing_date') : $book->publishing_date }}"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" value="{{ old('edition') ? old('edition') : $book->edition  }}"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" value="{{ old('isbn') ? old('isbn') : $book->isbn }}"
                                    ...
                                    <div class="form-row mb-2">
                                            ...
                                            <select id="language_id" name="language_id"
                                                ...
                                                @foreach ($languages as $language)
                                                    <option value="{{ $language->id }}"
                                                        {{ (old('language_id') == $language->id || (isset($book)&& $book->language_id == $language->id)) ? 'selected' : '' }}
                                            ...
                                            <select id="format" name="format"
                                                ...
                                                @foreach ($formats as $format)
                                                    <option value="{{ $format->id }}"
                                                        {{ (old('format') == $format->id || (isset($book)&& $book->format_id == $format->id)) ? 'selected' : '' }}
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" value="{{ old('pages') ? old('pages') : $book->pages}}"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <textarea name="summary" class="form-control @error('summary') is-invalid @enderror" id="summary" cols="30"
                                            rows="10">
                                        {{ old('summary') ? old('summary') : $book->summary}}
                                        </textarea>
                                        @error('summary')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div id="inventory"  class="tab-pane fade">
                                    <div class="form-row mb-2">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ old('price') ? old('price') : $book->price}}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ old('offer_price') ? old('offer_price') : $book->offer_price }}"
                                    ...
                                    <div class="form-row mb-2">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ old('stock') ? old('stock') : $book->stock }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ old('threshold_stock') ? old('threshold_stock') : $book->threshold_stock }}"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" {{ $book->outofstock_notify == 1 ?'checked':'' }} value="1" name="outofstock_check" id="outofstock_check">
                ...
                <div class="col-4 mb-3">
                    <div class="card mt-4">
                        ...
                        <div class="card-body mx-auto">
                                <div class="book-img-container mb-3" id="book-img-container">
                                    <img src="{{ asset('images/uploads/books/'.$book->image) }}" class="book-image-preview"
                    ...
                    <div class="form-group ">
                        <button type="submit" class="btn float-right btn-primary btn-sm add_new_btn" id="btn_language_form">Update</button>
                    </div>
                </div>
            </div>
          </form>
