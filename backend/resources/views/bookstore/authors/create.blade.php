        ...
        <div class="row">
           <div class="col-7">
            <div class="card mt-4">
                ...
                <div class="card-body">    
                  <form  method="POST" id="bookSubmitForm" action="{{ route('authors.store') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="card-body">     
                    ...
                    <div class="form-group mb-3">
                      ...
                      <div class="author-image-section">
                        <img src="{{ asset('images/profile.png') }}" id="author-profile-img" alt="" class="rounded-circle img-fluid img-thumbnail profile-image"  required>
